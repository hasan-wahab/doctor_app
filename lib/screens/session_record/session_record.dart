  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(isVisitDetail == true ? 'Total visits' : 'Session Records'),
        automaticallyImplyLeading: false,
      ),
      body: isVisitDetail == true
          // Visit Records
          ? RefreshIndicator(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      CustomText(
                                        text:
                                            visit.therapist?.name.isNotEmpty ==
                                                true
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      CustomText(
                                        text: visit.type ?? 'Cognitive Therapy',
                                        fontSize: 15,
                                        color: AppColors.secondaryTextColor,
                                      ),
                                    ],
